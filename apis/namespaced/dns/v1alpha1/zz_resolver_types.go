...
type AttachedViewsInitParameters struct {
	...
	ViewIDRef *v1.NamespacedReference `json:"viewIdRef,omitempty" tf:"-"`

	// Selector for a View in dns to populate viewId.
	// +kubebuilder:validation:Optional
	ViewIDSelector *v1.NamespacedSelector `json:"viewIdSelector,omitempty" tf:"-"`
}
...
type ResolverInitParameters struct {
	...
	// The OCID of the target resolver.
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/dns/v1alpha1.Resolver
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	ResolverID *string `json:"resolverId,omitempty" tf:"resolver_id,omitempty"`

	// Reference to a Resolver in dns to populate resolverId.
	// +kubebuilder:validation:Optional
	ResolverIDRef *v1.NamespacedReference `json:"resolverIdRef,omitempty" tf:"-"`

	// Selector for a Resolver in dns to populate resolverId.
	// +kubebuilder:validation:Optional
	ResolverIDSelector *v1.NamespacedSelector `json:"resolverIdSelector,omitempty" tf:"-"`
