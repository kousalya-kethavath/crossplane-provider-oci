...
type DatabaseDatabaseInitParameters struct {
	...
	DatabaseAdminPasswordSecretRef *v1.LocalSecretKeySelector `json:"databaseAdminPasswordSecretRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SourceDatabaseIDRef *v1.NamespacedReference `json:"sourceDatabaseIdRef,omitempty" tf:"-"`

	// Selector for a Database in database to populate sourceDatabaseId.
	// +kubebuilder:validation:Optional
	SourceDatabaseIDSelector *v1.NamespacedSelector `json:"sourceDatabaseIdSelector,omitempty" tf:"-"`
	...
	SourceTdeWalletPasswordSecretRef *v1.LocalSecretKeySelector `json:"sourceTdeWalletPasswordSecretRef,omitempty" tf:"-"`
...
type DatabaseEncryptionKeyLocationDetailsInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	AzureEncryptionKeyIDRef *v1.NamespacedReference `json:"azureEncryptionKeyIdRef,omitempty" tf:"-"`

	// Selector for a Key in kms to populate azureEncryptionKeyId.
	// +kubebuilder:validation:Optional
	AzureEncryptionKeyIDSelector *v1.NamespacedSelector `json:"azureEncryptionKeyIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	GoogleCloudProviderEncryptionKeyIDRef *v1.NamespacedReference `json:"googleCloudProviderEncryptionKeyIdRef,omitempty" tf:"-"`

	// Selector for a Key in kms to populate googleCloudProviderEncryptionKeyId.
	// +kubebuilder:validation:Optional
	GoogleCloudProviderEncryptionKeyIDSelector *v1.NamespacedSelector `json:"googleCloudProviderEncryptionKeyIdSelector,omitempty" tf:"-"`
...
type DatabaseInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	DBHomeIDRef *v1.NamespacedReference `json:"dbHomeIdRef,omitempty" tf:"-"`

	// Selector for a DbHome in database to populate dbHomeId.
	// +kubebuilder:validation:Optional
	DBHomeIDSelector *v1.NamespacedSelector `json:"dbHomeIdSelector,omitempty" tf:"-"`
