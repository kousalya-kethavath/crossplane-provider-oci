...
type ManagementCloudDbNodeInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/database/v1alpha1.ManagementCloudDbNode
	...
	CloudDBNodeIDRef *v1.NamespacedReference `json:"cloudDbNodeIdRef,omitempty" tf:"-"`

	// Selector for a ManagementCloudDbNode in database to populate cloudDbNodeId.
	// +kubebuilder:validation:Optional
	CloudDBNodeIDSelector *v1.NamespacedSelector `json:"cloudDbNodeIdSelector,omitempty" tf:"-"`
...
type ManagementCloudDbNodeObservation struct {
...
type ManagementCloudDbNodeParameters struct {
...
// ManagementCloudDbNodeSpec defines the desired state of ManagementCloudDbNode
type ManagementCloudDbNodeSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            ManagementCloudDbNodeParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ManagementCloudDbNodeInitParameters `json:"initProvider,omitempty"`
}

// ManagementCloudDbNodeStatus defines the observed state of ManagementCloudDbNode.
type ManagementCloudDbNodeStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ManagementCloudDbNodeObservation `json:"atProvider,omitempty"`
}
...
// ManagementCloudDbNode is the Schema for the ManagementCloudDbNodes API. Provides the Cloud Db Node resource in Oracle Cloud Infrastructure Database Management service
...
// ManagementCloudDbNodeList contains a list of ManagementCloudDbNodes
type ManagementCloudDbNodeList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ManagementCloudDbNode `json:"items"`
}

// Repository type metadata.
var (
	ManagementCloudDbNode_Kind             = "ManagementCloudDbNode"
	ManagementCloudDbNode_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ManagementCloudDbNode_Kind}.String()
	ManagementCloudDbNode_KindAPIVersion   = ManagementCloudDbNode_Kind + "." + CRDGroupVersion.String()
	ManagementCloudDbNode_GroupVersionKind = CRDGroupVersion.WithKind(ManagementCloudDbNode_Kind)
)

func init() {
	SchemeBuilder.Register(&ManagementCloudDbNode{}, &ManagementCloudDbNodeList{})
}
