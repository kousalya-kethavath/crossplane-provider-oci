...
type PdbCreationTypeDetailsInitParameters struct {
	...
	DblinkUserPasswordSecretRef *v1.LocalSecretKeySelector `json:"dblinkUserPasswordSecretRef,omitempty" tf:"-"`
	...
	SourceContainerDatabaseAdminPasswordSecretRef *v1.LocalSecretKeySelector `json:"sourceContainerDatabaseAdminPasswordSecretRef,omitempty" tf:"-"`
	...
	SourcePluggableDatabaseIDRef *v1.NamespacedReference `json:"sourcePluggableDatabaseIdRef,omitempty" tf:"-"`
...
type PluggableDatabaseInitParameters struct {
	...
	ContainerDatabaseAdminPasswordSecretRef *v1.LocalSecretKeySelector `json:"containerDatabaseAdminPasswordSecretRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	ContainerDatabaseIDRef *v1.NamespacedReference `json:"containerDatabaseIdRef,omitempty" tf:"-"`

	// Selector for a Database in database to populate containerDatabaseId.
	// +kubebuilder:validation:Optional
	ContainerDatabaseIDSelector *v1.NamespacedSelector `json:"containerDatabaseIdSelector,omitempty" tf:"-"`
	...
	PdbAdminPasswordSecretRef *v1.LocalSecretKeySelector `json:"pdbAdminPasswordSecretRef,omitempty" tf:"-"`
