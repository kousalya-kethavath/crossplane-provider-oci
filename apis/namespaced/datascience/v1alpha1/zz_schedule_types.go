...
type ActionDetailsInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/dns/v1alpha1.View
	...
	MLApplicationInstanceViewIDRef *v1.NamespacedReference `json:"mlApplicationInstanceViewIdRef,omitempty" tf:"-"`

	// Selector for a View in dns to populate mlApplicationInstanceViewId.
	// +kubebuilder:validation:Optional
	MLApplicationInstanceViewIDSelector *v1.NamespacedSelector `json:"mlApplicationInstanceViewIdSelector,omitempty" tf:"-"`
...
type CreatePipelineRunDetailsInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/datascience/v1alpha1.Pipeline
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
...
type TriggerMLApplicationInstanceViewFlowDetailsInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/devops/v1alpha1.Trigger
	...
	// +kubebuilder:validation:Optional
	TriggerNameRef *v1.NamespacedReference `json:"triggerNameRef,omitempty" tf:"-"`

	// Selector for a Trigger in devops to populate triggerName.
	// +kubebuilder:validation:Optional
	TriggerNameSelector *v1.NamespacedSelector `json:"triggerNameSelector,omitempty" tf:"-"`
}
