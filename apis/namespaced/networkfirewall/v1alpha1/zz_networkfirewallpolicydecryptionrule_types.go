...
type NetworkFirewallPolicyDecryptionRuleInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/networkfirewall/v1alpha1.NetworkFirewallPolicy
	...
	// +kubebuilder:validation:Optional
	NetworkFirewallPolicyIDRef *v1.NamespacedReference `json:"networkFirewallPolicyIdRef,omitempty" tf:"-"`

	// Selector for a NetworkFirewallPolicy in networkfirewall to populate networkFirewallPolicyId.
	// +kubebuilder:validation:Optional
	NetworkFirewallPolicyIDSelector *v1.NamespacedSelector `json:"networkFirewallPolicyIdSelector,omitempty" tf:"-"`
