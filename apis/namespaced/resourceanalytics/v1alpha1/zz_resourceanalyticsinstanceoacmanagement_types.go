...
type AttachmentDetailsInitParameters struct {
	...
	IdcsDomainIDRef *v1.NamespacedReference `json:"idcsDomainIdRef,omitempty" tf:"-"`

	// Selector for a Domain in identity to populate idcsDomainId.
	// +kubebuilder:validation:Optional
	IdcsDomainIDSelector *v1.NamespacedSelector `json:"idcsDomainIdSelector,omitempty" tf:"-"`
