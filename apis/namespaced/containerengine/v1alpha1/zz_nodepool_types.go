...
type NodePoolInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	NodeImageNameRef *v1.NamespacedReference `json:"nodeImageNameRef,omitempty" tf:"-"`

	// Selector for a Image in compute to populate nodeImageName.
	// +kubebuilder:validation:Optional
	NodeImageNameSelector *v1.NamespacedSelector `json:"nodeImageNameSelector,omitempty" tf:"-"`
...
type PlacementConfigsInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	HostGroupIDRef *v1.NamespacedReference `json:"hostGroupIdRef,omitempty" tf:"-"`

	// Selector for a Group in identity to populate hostGroupId.
	// +kubebuilder:validation:Optional
	HostGroupIDSelector *v1.NamespacedSelector `json:"hostGroupIdSelector,omitempty" tf:"-"`
