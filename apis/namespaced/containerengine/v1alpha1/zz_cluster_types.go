...
type OptionsInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	ServiceLBSubnetIDSelector *v1.NamespacedSelector `json:"serviceLbSubnetIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	ServiceLBSubnetIdsRef []v1.NamespacedReference `json:"serviceLbSubnetIdsRef,omitempty" tf:"-"`
}
