...
type DeploymentInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	ClusterPlacementGroupIDRef *v1.NamespacedReference `json:"clusterPlacementGroupIdRef,omitempty" tf:"-"`

	// Selector for a ClusterPlacementGroup in clusterplacementgroups to populate clusterPlacementGroupId.
	// +kubebuilder:validation:Optional
	ClusterPlacementGroupIDSelector *v1.NamespacedSelector `json:"clusterPlacementGroupIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	DeploymentBackupIDRef *v1.NamespacedReference `json:"deploymentBackupIdRef,omitempty" tf:"-"`

	// Selector for a DeploymentBackup in goldengate to populate deploymentBackupId.
	// +kubebuilder:validation:Optional
	DeploymentBackupIDSelector *v1.NamespacedSelector `json:"deploymentBackupIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	LoadBalancerSubnetIDRef *v1.NamespacedReference `json:"loadBalancerSubnetIdRef,omitempty" tf:"-"`

	// Selector for a Subnet in networking to populate loadBalancerSubnetId.
	// +kubebuilder:validation:Optional
	LoadBalancerSubnetIDSelector *v1.NamespacedSelector `json:"loadBalancerSubnetIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SourceDeploymentIDRef *v1.NamespacedReference `json:"sourceDeploymentIdRef,omitempty" tf:"-"`
...
type GroupToRolesMappingInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	AdministratorGroupIDRef *v1.NamespacedReference `json:"administratorGroupIdRef,omitempty" tf:"-"`

	// Selector for a Group in identity to populate administratorGroupId.
	// +kubebuilder:validation:Optional
	AdministratorGroupIDSelector *v1.NamespacedSelector `json:"administratorGroupIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	OperatorGroupIDRef *v1.NamespacedReference `json:"operatorGroupIdRef,omitempty" tf:"-"`

	// Selector for a Group in identity to populate operatorGroupId.
	// +kubebuilder:validation:Optional
	OperatorGroupIDSelector *v1.NamespacedSelector `json:"operatorGroupIdSelector,omitempty" tf:"-"`
...
type OggDataInitParameters struct {
	...
	PasswordSecretIDSecretRef *v1.LocalSecretKeySelector `json:"passwordSecretIdSecretRef,omitempty" tf:"-"`
}
