...
type CatalogDetailsInitParameters struct {
	...
	OkvEndPointGroup *string `json:"okvEndPointGroup,omitempty" tf:"okv_end_point_group,omitempty"`
	...
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	OkvKeyStoreID *string `json:"okvKeyStoreId,omitempty" tf:"okv_key_store_id,omitempty"`

	// Reference to a KeyStore in database to populate okvKeyStoreId.
	// +kubebuilder:validation:Optional
	OkvKeyStoreIDRef *v1.NamespacedReference `json:"okvKeyStoreIdRef,omitempty" tf:"-"`

	// Selector for a KeyStore in database to populate okvKeyStoreId.
	// +kubebuilder:validation:Optional
	OkvKeyStoreIDSelector *v1.NamespacedSelector `json:"okvKeyStoreIdSelector,omitempty" tf:"-"`
...
type DistributedAutonomousDatabaseInitParameters struct {
	...
	// The OCID of the cluster certificate to pass to Configure Sharding. Required when configure_sharding_trigger is incremented.
	...
	UploadCASignedCertificateSecretRef *v1.LocalSecretKeySelector `json:"uploadCaSignedCertificateSecretRef,omitempty" tf:"-"`
...
type DistributedAutonomousDatabaseMetadataObservation struct {
...
type DistributedAutonomousDatabaseMetadataParameters struct {
}

type DistributedAutonomousDatabaseObservation struct {
...
// DistributedAutonomousDatabaseSpec defines the desired state of DistributedAutonomousDatabase
type DistributedAutonomousDatabaseSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            DistributedAutonomousDatabaseParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider DistributedAutonomousDatabaseInitParameters `json:"initProvider,omitempty"`
}

// DistributedAutonomousDatabaseStatus defines the observed state of DistributedAutonomousDatabase.
type DistributedAutonomousDatabaseStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        DistributedAutonomousDatabaseObservation `json:"atProvider,omitempty"`
}
...
// DistributedAutonomousDatabase is the Schema for the DistributedAutonomousDatabases API. Provides the Distributed Autonomous Database resource in Oracle Cloud Infrastructure Distributed Database service
...
type DistributedAutonomousDatabase struct {
	...
	Spec   DistributedAutonomousDatabaseSpec   `json:"spec"`
	Status DistributedAutonomousDatabaseStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// DistributedAutonomousDatabaseList contains a list of DistributedAutonomousDatabases
type DistributedAutonomousDatabaseList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []DistributedAutonomousDatabase `json:"items"`
}

// Repository type metadata.
var (
	DistributedAutonomousDatabase_Kind             = "DistributedAutonomousDatabase"
	DistributedAutonomousDatabase_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: DistributedAutonomousDatabase_Kind}.String()
	DistributedAutonomousDatabase_KindAPIVersion   = DistributedAutonomousDatabase_Kind + "." + CRDGroupVersion.String()
	DistributedAutonomousDatabase_GroupVersionKind = CRDGroupVersion.WithKind(DistributedAutonomousDatabase_Kind)
)

func init() {
	SchemeBuilder.Register(&DistributedAutonomousDatabase{}, &DistributedAutonomousDatabaseList{})
}
