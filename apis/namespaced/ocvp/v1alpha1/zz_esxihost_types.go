...
type EsxiHostInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/ocvp/v1alpha1.Cluster
	...
	// +kubebuilder:validation:Optional
	VcfByolAllocationIDRef *v1.NamespacedReference `json:"vcfByolAllocationIdRef,omitempty" tf:"-"`

	// Selector for a ByolAllocation in ocvp to populate vcfByolAllocationId.
	// +kubebuilder:validation:Optional
	VcfByolAllocationIDSelector *v1.NamespacedSelector `json:"vcfByolAllocationIdSelector,omitempty" tf:"-"`
}
