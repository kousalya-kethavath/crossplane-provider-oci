...
type ByolAllocationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/ocvp/v1alpha1.Byol
	...
	ByolIDRef *v1.NamespacedReference `json:"byolIdRef,omitempty" tf:"-"`

	// Selector for a Byol in ocvp to populate byolId.
	// +kubebuilder:validation:Optional
	ByolIDSelector *v1.NamespacedSelector `json:"byolIdSelector,omitempty" tf:"-"`
