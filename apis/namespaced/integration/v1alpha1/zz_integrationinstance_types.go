...
type AlternateCustomEndpointsInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	CertificateSecretIDRef *v1.NamespacedReference `json:"certificateSecretIdRef,omitempty" tf:"-"`

	// Selector for a Secret in vault to populate certificateSecretId.
	// +kubebuilder:validation:Optional
	CertificateSecretIDSelector *v1.NamespacedSelector `json:"certificateSecretIdSelector,omitempty" tf:"-"`
