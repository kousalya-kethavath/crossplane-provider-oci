...
type CostAlertSubscriptionMapInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/costad/v1alpha1.CostAlertSubscription
	...
	// Reference to a CostAlertSubscription in costad to populate costAlertSubscriptionId.
	// +kubebuilder:validation:Optional
	CostAlertSubscriptionIDRef *v1.NamespacedReference `json:"costAlertSubscriptionIdRef,omitempty" tf:"-"`

	// Selector for a CostAlertSubscription in costad to populate costAlertSubscriptionId.
	// +kubebuilder:validation:Optional
	CostAlertSubscriptionIDSelector *v1.NamespacedSelector `json:"costAlertSubscriptionIdSelector,omitempty" tf:"-"`
...
// CostAnomalyMonitor is the Schema for the CostAnomalyMonitors API. Provides the Cost Anomaly Monitor resource in Oracle Cloud Infrastructure Costad service
