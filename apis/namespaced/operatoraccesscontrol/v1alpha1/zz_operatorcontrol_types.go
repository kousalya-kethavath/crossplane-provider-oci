...
type OperatorControlInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/operatoraccesscontrol/v1alpha1.OperatorControl
	...
	// +kubebuilder:validation:Optional
	OperatorControlNameRef *v1.NamespacedReference `json:"operatorControlNameRef,omitempty" tf:"-"`

	// Selector for a OperatorControl in operatoraccesscontrol to populate operatorControlName.
	// +kubebuilder:validation:Optional
	OperatorControlNameSelector *v1.NamespacedSelector `json:"operatorControlNameSelector,omitempty" tf:"-"`
