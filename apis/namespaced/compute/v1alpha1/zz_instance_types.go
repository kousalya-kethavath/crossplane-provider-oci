...
type CreateVnicDetailsInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	NsgIdsRefs []v1.NamespacedReference `json:"nsgIdsRefs,omitempty" tf:"-"`

	// Selector for a list of NetworkSecurityGroup in networking to populate nsgIds.
	// +kubebuilder:validation:Optional
	NsgIdsSelector *v1.NamespacedSelector `json:"nsgIdsSelector,omitempty" tf:"-"`
...
type SourceDetailsInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	SourceIDRef *v1.NamespacedReference `json:"sourceIdRef,omitempty" tf:"-"`
