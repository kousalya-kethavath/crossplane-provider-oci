...
type ComputeGpuMemoryFabricInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/compute/v1alpha1.ComputeGpuMemoryFabric
	...
	// +kubebuilder:validation:Optional
	ComputeGpuMemoryFabricIDRef *v1.NamespacedReference `json:"computeGpuMemoryFabricIdRef,omitempty" tf:"-"`
