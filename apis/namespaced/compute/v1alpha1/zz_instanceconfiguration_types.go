...
type BlockVolumesCreateDetailsInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	XrcKMSKeyIDRef *v1.NamespacedReference `json:"xrcKmsKeyIdRef,omitempty" tf:"-"`

	// Selector for a Key in kms to populate xrcKmsKeyId.
	// +kubebuilder:validation:Optional
	XrcKMSKeyIDSelector *v1.NamespacedSelector `json:"xrcKmsKeyIdSelector,omitempty" tf:"-"`
}
...
type LaunchDetailsInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/compute/v1alpha1.ComputeCluster
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// +kubebuilder:validation:Optional
	ComputeClusterIDRef *v1.NamespacedReference `json:"computeClusterIdRef,omitempty" tf:"-"`

	// Selector for a ComputeCluster in compute to populate computeClusterId.
	// +kubebuilder:validation:Optional
	ComputeClusterIDSelector *v1.NamespacedSelector `json:"computeClusterIdSelector,omitempty" tf:"-"`
...
type LaunchDetailsPlacementConstraintDetailsInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/compute/v1alpha1.ComputeHostGroup
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// +kubebuilder:validation:Optional
	ComputeHostGroupIDRef *v1.NamespacedReference `json:"computeHostGroupIdRef,omitempty" tf:"-"`

	// Selector for a ComputeHostGroup in compute to populate computeHostGroupId.
	// +kubebuilder:validation:Optional
	ComputeHostGroupIDSelector *v1.NamespacedSelector `json:"computeHostGroupIdSelector,omitempty" tf:"-"`
