...
type CertificateConfigInitParameters struct {
	...
	OpenSearchAPICertificateIDRef *v1.NamespacedReference `json:"openSearchApiCertificateIdRef,omitempty" tf:"-"`

	// Selector for a Certificate in apigateway to populate openSearchApiCertificateId.
	// +kubebuilder:validation:Optional
	OpenSearchAPICertificateIDSelector *v1.NamespacedSelector `json:"openSearchApiCertificateIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	OpenSearchDashboardCertificateIDRef *v1.NamespacedReference `json:"openSearchDashboardCertificateIdRef,omitempty" tf:"-"`

	// Selector for a Certificate in apigateway to populate openSearchDashboardCertificateId.
	// +kubebuilder:validation:Optional
	OpenSearchDashboardCertificateIDSelector *v1.NamespacedSelector `json:"openSearchDashboardCertificateIdSelector,omitempty" tf:"-"`
}
...
type OpensearchClusterInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	SecurityMasterUserNameRef *v1.NamespacedReference `json:"securityMasterUserNameRef,omitempty" tf:"-"`

	// Selector for a User in identity to populate securityMasterUserName.
	// +kubebuilder:validation:Optional
	SecurityMasterUserNameSelector *v1.NamespacedSelector `json:"securityMasterUserNameSelector,omitempty" tf:"-"`

	// (Updatable) The password hash of the master user that are used to manage security config
	SecurityMasterUserPasswordHashSecretRef *v1.LocalSecretKeySelector `json:"securityMasterUserPasswordHashSecretRef,omitempty" tf:"-"`
...
type OutboundClustersInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/namespaced/opensearch/v1alpha1.OpensearchCluster
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// +kubebuilder:validation:Optional
	SeedClusterIDRef *v1.NamespacedReference `json:"seedClusterIdRef,omitempty" tf:"-"`

	// Selector for a OpensearchCluster in opensearch to populate seedClusterId.
	// +kubebuilder:validation:Optional
	SeedClusterIDSelector *v1.NamespacedSelector `json:"seedClusterIdSelector,omitempty" tf:"-"`
}
