...
type DeploymentInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/cluster/goldengate/v1alpha1.DeploymentBackup
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
...
type OggDataInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	KeySecretIDRef *v1.Reference `json:"keySecretIdRef,omitempty" tf:"-"`

	// Selector for a Secret in vault to populate keySecretId.
	// +kubebuilder:validation:Optional
	KeySecretIDSelector *v1.Selector `json:"keySecretIdSelector,omitempty" tf:"-"`
