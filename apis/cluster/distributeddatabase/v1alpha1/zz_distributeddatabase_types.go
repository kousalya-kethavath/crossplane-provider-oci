...
type CatalogDetailsPeerDetailsInitParameters struct {
	...
	DBStorageVaultDetails []PeerDetailsDBStorageVaultDetailsInitParameters `json:"dbStorageVaultDetails,omitempty" tf:"db_storage_vault_details,omitempty"`

	// (Applicable when source=EXADB_XS | NEW_VAULT_AND_CLUSTER) The protectionMode for the catalog peer.
	ProtectionMode *string `json:"protectionMode,omitempty" tf:"protection_mode,omitempty"`

	// (Applicable when source=EXADB_XS | NEW_VAULT_AND_CLUSTER) The redo transport type to use for this Data Guard association.
	...
	VMClusterDetails []VMClusterDetailsInitParameters `json:"vmClusterDetails,omitempty" tf:"vm_cluster_details,omitempty"`
...
type CatalogDetailsPeerDetailsObservation struct {
	...
	// Details of the request to create exascale db vault storage for shard or catalog of the distributed database.
	DBStorageVaultDetails []PeerDetailsDBStorageVaultDetailsObservation `json:"dbStorageVaultDetails,omitempty" tf:"db_storage_vault_details,omitempty"`
	...
	// Details of the request to create exadb vm cluster for shard or catalog of the distributed database.
	VMClusterDetails []VMClusterDetailsObservation `json:"vmClusterDetails,omitempty" tf:"vm_cluster_details,omitempty"`
...
type CatalogDetailsPeerDetailsParameters struct {
	...
	// Details of the request to create exascale db vault storage for shard or catalog of the distributed database.
	// +kubebuilder:validation:Optional
	DBStorageVaultDetails []PeerDetailsDBStorageVaultDetailsParameters `json:"dbStorageVaultDetails,omitempty" tf:"db_storage_vault_details,omitempty"`
	...
	// Details of the request to create exadb vm cluster for shard or catalog of the distributed database.
	// +kubebuilder:validation:Optional
	VMClusterDetails []VMClusterDetailsParameters `json:"vmClusterDetails,omitempty" tf:"vm_cluster_details,omitempty"`
...
type CatalogDetailsVMClusterDetailsInitParameters struct {

	// (Applicable when source=NEW_VAULT_AND_CLUSTER) A list of the OCIDs of the network security groups (NSGs) that the backup network of this DB system belongs to.  Setting this to an empty array after the list is created removes the resource from all NSGs.  For more information about NSGs, see Security Rules. Applicable only to Exadata systems.
	// +listType=set
	...
	// (Applicable when source=NEW_VAULT_AND_CLUSTER) A domain name used for the Exadata VM cluster on Exascale Infrastructure.  If the Oracle-provided internet and VCN resolver is enabled for the specified subnet, then the domain name for the subnet is used (do not provide one). Otherwise, provide a valid DNS domain name.  Hyphens (-) are not permitted. Applies to Exadata Database Service on Exascale Infrastructure only.
	...
	// (Applicable when source=NEW_VAULT_AND_CLUSTER) Indicates whether incident logs and trace collection are enabled for the VM cluster.  Enabling incident logs collection allows Oracle to receive Events service notifications for guest VM issues, collect incident logs and traces, and use them to diagnose issues and resolve them. Optionally enable incident logs collection while provisioning a system. You can also disable or enable incident logs collection anytime using the UpdateVmCluster API.
	IsIncidentLogsEnabled *bool `json:"isIncidentLogsEnabled,omitempty" tf:"is_incident_logs_enabled,omitempty"`

	// (Applicable when source=NEW_VAULT_AND_CLUSTER) The Oracle license model that applies to the Exadata VM cluster on Exascale Infrastructure. The default is BRING_YOUR_OWN_LICENSE.
	LicenseModel *string `json:"licenseModel,omitempty" tf:"license_model,omitempty"`

	// (Applicable when source=NEW_VAULT_AND_CLUSTER) The list of OCIDs for the network security groups (NSGs) to which this resource belongs.  Setting this to an empty list removes all resources from all NSGs.  For more information about NSGs, see Security Rules.
	// +listType=set
	NsgIds []*string `json:"nsgIds,omitempty" tf:"nsg_ids,omitempty"`

	// (Applicable when source=NEW_VAULT_AND_CLUSTER) The private zone ID in which you want DNS records to be created.
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/cluster/dns/v1alpha1.Zone
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
...
type DistributedDatabaseCatalogDetailsInitParameters struct {
	...
	// Details of the request to create exascale db vault storage for shard or catalog of the distributed database.
	DBStorageVaultDetails []DBStorageVaultDetailsInitParameters `json:"dbStorageVaultDetails,omitempty" tf:"db_storage_vault_details,omitempty"`
	...
	// (Applicable when source=EXADB_XS) This field is deprecated. This should not be used while creation of new distributed database. To set the peers on catalog of distributed database please use peerDetails.
	...
	// Details of the request to create exadb vm cluster for shard or catalog of the distributed database.
	VMClusterDetails []CatalogDetailsVMClusterDetailsInitParameters `json:"vmClusterDetails,omitempty" tf:"vm_cluster_details,omitempty"`
...
type DistributedDatabaseCatalogDetailsObservation struct {
	...
	// Details of the request to create exascale db vault storage for shard or catalog of the distributed database.
	DBStorageVaultDetails []DBStorageVaultDetailsObservation `json:"dbStorageVaultDetails,omitempty" tf:"db_storage_vault_details,omitempty"`
	...
	// Details of the request to create exadb vm cluster for shard or catalog of the distributed database.
	VMClusterDetails []CatalogDetailsVMClusterDetailsObservation `json:"vmClusterDetails,omitempty" tf:"vm_cluster_details,omitempty"`
...
type DistributedDatabaseCatalogDetailsParameters struct {
	...
	// Details of the request to create exascale db vault storage for shard or catalog of the distributed database.
	// +kubebuilder:validation:Optional
	DBStorageVaultDetails []DBStorageVaultDetailsParameters `json:"dbStorageVaultDetails,omitempty" tf:"db_storage_vault_details,omitempty"`
	...
	// Details of the request to create exadb vm cluster for shard or catalog of the distributed database.
	// +kubebuilder:validation:Optional
	VMClusterDetails []CatalogDetailsVMClusterDetailsParameters `json:"vmClusterDetails,omitempty" tf:"vm_cluster_details,omitempty"`
...
type DistributedDatabaseConnectionStringsInitParameters struct {
}
...
type DistributedDatabaseDBBackupConfigInitParameters struct {
...
type DistributedDatabaseDBBackupConfigObservation struct {
...
type DistributedDatabaseDBBackupConfigParameters struct {
...
type DistributedDatabaseGsmDetailsInitParameters struct {
}

type DistributedDatabaseGsmDetailsMetadataInitParameters struct {
}

type DistributedDatabaseGsmDetailsMetadataObservation struct {
...
type DistributedDatabaseGsmDetailsMetadataParameters struct {
}

type DistributedDatabaseGsmDetailsObservation struct {
	...
	// Additional metadata related to Globally distributed database resources.
	Metadata []DistributedDatabaseGsmDetailsMetadataObservation `json:"metadata,omitempty" tf:"metadata,omitempty"`
...
type DistributedDatabaseGsmDetailsParameters struct {
}

type DistributedDatabaseInitParameters struct {
...
type DistributedDatabaseMetadataObservation struct {
...
type DistributedDatabaseMetadataParameters struct {
}

type DistributedDatabaseObservation struct {
	...
	// Backup Options To use any of the API operations, you must be authorized in an IAM policy. If you're not authorized, talk to an administrator. If you're an administrator who needs to write policies to give users access, see Getting Started with Policies.
	DBBackupConfig []DistributedDatabaseDBBackupConfigObservation `json:"dbBackupConfig,omitempty" tf:"db_backup_config,omitempty"`
...
type DistributedDatabaseParameters struct {
	...
	// Collection of catalog for the Globally distributed database.
	// +kubebuilder:validation:Optional
	CatalogDetails []DistributedDatabaseCatalogDetailsParameters `json:"catalogDetails,omitempty" tf:"catalog_details,omitempty"`
	...
	// Backup Options To use any of the API operations, you must be authorized in an IAM policy. If you're not authorized, talk to an administrator. If you're an administrator who needs to write policies to give users access, see Getting Started with Policies.
	// +kubebuilder:validation:Optional
	DBBackupConfig []DistributedDatabaseDBBackupConfigParameters `json:"dbBackupConfig,omitempty" tf:"db_backup_config,omitempty"`
	...
	// (Updatable)
	// +kubebuilder:validation:Optional
	PatchOperations []DistributedDatabasePatchOperationsParameters `json:"patchOperations,omitempty" tf:"patch_operations,omitempty"`
	...
	// Collection of shards for the Globally distributed database.
	// +kubebuilder:validation:Optional
	ShardDetails []DistributedDatabaseShardDetailsParameters `json:"shardDetails,omitempty" tf:"shard_details,omitempty"`
...
type DistributedDatabasePatchOperationsObservation struct {
...
type DistributedDatabasePatchOperationsParameters struct {
...
type DistributedDatabaseShardDetailsInitParameters struct {
	...
	// Details of the request to create exascale db vault storage for shard or catalog of the distributed database.
	DBStorageVaultDetails []ShardDetailsDBStorageVaultDetailsInitParameters `json:"dbStorageVaultDetails,omitempty" tf:"db_storage_vault_details,omitempty"`
	...
	// The details required for creation of the peer for the ExadbXs infrastructure based catalog.
	PeerDetails []DistributedDatabaseShardDetailsPeerDetailsInitParameters `json:"peerDetails,omitempty" tf:"peer_details,omitempty"`
	...
	// Details of the request to create exadb vm cluster for shard or catalog of the distributed database.
	VMClusterDetails []ShardDetailsVMClusterDetailsInitParameters `json:"vmClusterDetails,omitempty" tf:"vm_cluster_details,omitempty"`
...
type DistributedDatabaseShardDetailsMetadataInitParameters struct {
}

type DistributedDatabaseShardDetailsMetadataObservation struct {
...
type DistributedDatabaseShardDetailsMetadataParameters struct {
}

type DistributedDatabaseShardDetailsObservation struct {
	...
	// Details of the request to create exascale db vault storage for shard or catalog of the distributed database.
	DBStorageVaultDetails []ShardDetailsDBStorageVaultDetailsObservation `json:"dbStorageVaultDetails,omitempty" tf:"db_storage_vault_details,omitempty"`
	...
	// Additional metadata related to Globally distributed database resources.
	Metadata []DistributedDatabaseShardDetailsMetadataObservation `json:"metadata,omitempty" tf:"metadata,omitempty"`

	// The name of catalog.
	Name *string `json:"name,omitempty" tf:"name,omitempty"`

	// The details required for creation of the peer for the ExadbXs infrastructure based catalog.
	PeerDetails []DistributedDatabaseShardDetailsPeerDetailsObservation `json:"peerDetails,omitempty" tf:"peer_details,omitempty"`
	...
	// Details of the request to create exadb vm cluster for shard or catalog of the distributed database.
	VMClusterDetails []ShardDetailsVMClusterDetailsObservation `json:"vmClusterDetails,omitempty" tf:"vm_cluster_details,omitempty"`
...
type DistributedDatabaseShardDetailsParameters struct {
	...
	// Details of the request to create exascale db vault storage for shard or catalog of the distributed database.
	// +kubebuilder:validation:Optional
	DBStorageVaultDetails []ShardDetailsDBStorageVaultDetailsParameters `json:"dbStorageVaultDetails,omitempty" tf:"db_storage_vault_details,omitempty"`
	...
	// The details required for creation of the peer for the ExadbXs infrastructure based catalog.
	// +kubebuilder:validation:Optional
	PeerDetails []DistributedDatabaseShardDetailsPeerDetailsParameters `json:"peerDetails,omitempty" tf:"peer_details,omitempty"`
	...
	// Details of the request to create exadb vm cluster for shard or catalog of the distributed database.
	// +kubebuilder:validation:Optional
	VMClusterDetails []ShardDetailsVMClusterDetailsParameters `json:"vmClusterDetails,omitempty" tf:"vm_cluster_details,omitempty"`
...
type DistributedDatabaseShardDetailsPeerDetailsInitParameters struct {

	// The name of the availability domain that the distributed database shard will be located in.
	AvailabilityDomain *string `json:"availabilityDomain,omitempty" tf:"availability_domain,omitempty"`

	// Details of the request to create exascale db vault storage for shard or catalog of the distributed database.
	DBStorageVaultDetails []ShardDetailsPeerDetailsDBStorageVaultDetailsInitParameters `json:"dbStorageVaultDetails,omitempty" tf:"db_storage_vault_details,omitempty"`
	...
	// Details of the request to create exadb vm cluster for shard or catalog of the distributed database.
	VMClusterDetails []PeerDetailsVMClusterDetailsInitParameters `json:"vmClusterDetails,omitempty" tf:"vm_cluster_details,omitempty"`
...
type DistributedDatabaseShardDetailsPeerDetailsMetadataInitParameters struct {
}

type DistributedDatabaseShardDetailsPeerDetailsMetadataObservation struct {
...
type DistributedDatabaseShardDetailsPeerDetailsMetadataParameters struct {
}

type DistributedDatabaseShardDetailsPeerDetailsObservation struct {
	...
	// Details of the request to create exascale db vault storage for shard or catalog of the distributed database.
	DBStorageVaultDetails []ShardDetailsPeerDetailsDBStorageVaultDetailsObservation `json:"dbStorageVaultDetails,omitempty" tf:"db_storage_vault_details,omitempty"`

	// Additional metadata related to Globally distributed database resources.
	Metadata []DistributedDatabaseShardDetailsPeerDetailsMetadataObservation `json:"metadata,omitempty" tf:"metadata,omitempty"`
	...
	// Details of the request to create exadb vm cluster for shard or catalog of the distributed database.
	VMClusterDetails []PeerDetailsVMClusterDetailsObservation `json:"vmClusterDetails,omitempty" tf:"vm_cluster_details,omitempty"`

	// The OCID of the VM Cluster for the catalog peer.
	VMClusterID *string `json:"vmClusterId,omitempty" tf:"vm_cluster_id,omitempty"`
}

type DistributedDatabaseShardDetailsPeerDetailsParameters struct {
	...
	// Details of the request to create exascale db vault storage for shard or catalog of the distributed database.
	// +kubebuilder:validation:Optional
	DBStorageVaultDetails []ShardDetailsPeerDetailsDBStorageVaultDetailsParameters `json:"dbStorageVaultDetails,omitempty" tf:"db_storage_vault_details,omitempty"`
	...
	// Details of the request to create exadb vm cluster for shard or catalog of the distributed database.
	// +kubebuilder:validation:Optional
	VMClusterDetails []PeerDetailsVMClusterDetailsParameters `json:"vmClusterDetails,omitempty" tf:"vm_cluster_details,omitempty"`
...
type DistributedDatabaseValidateNetworkDetailsInitParameters struct {
...
type DistributedDatabaseValidateNetworkDetailsObservation struct {
	IsSurrogate *bool `json:"isSurrogate,omitempty" tf:"is_surrogate,omitempty"`
...
type DistributedDatabaseValidateNetworkDetailsParameters struct {
...
type DistributedDatabaseSpec struct {
	...
	ForProvider     DistributedDatabaseParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider DistributedDatabaseInitParameters `json:"initProvider,omitempty"`
}

// DistributedDatabaseStatus defines the observed state of DistributedDatabase.
type DistributedDatabaseStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        DistributedDatabaseObservation `json:"atProvider,omitempty"`
}
...
// DistributedDatabase is the Schema for the DistributedDatabases API. Provides the Distributed Database resource in Oracle Cloud Infrastructure Distributed Database service
...
// DistributedDatabaseList contains a list of DistributedDatabases
...
var (
	DistributedDatabase_Kind             = "DistributedDatabase"
	DistributedDatabase_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: DistributedDatabase_Kind}.String()
	DistributedDatabase_KindAPIVersion   = DistributedDatabase_Kind + "." + CRDGroupVersion.String()
	DistributedDatabase_GroupVersionKind = CRDGroupVersion.WithKind(DistributedDatabase_Kind)
)
