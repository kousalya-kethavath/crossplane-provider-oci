...
type IdentityPropagationTrustInitParameters struct {
	...
	Tags []IdentityPropagationTrustTagsInitParameters `json:"tags,omitempty" tf:"tags,omitempty"`
...
type IdentityPropagationTrustObservation struct {
	...
	IdcsCreatedBy []IdentityPropagationTrustIdcsCreatedByObservation `json:"idcsCreatedBy,omitempty" tf:"idcs_created_by,omitempty"`

	// The basic endpoint for the identity domain
	IdcsEndpoint *string `json:"idcsEndpoint,omitempty" tf:"idcs_endpoint,omitempty"`

	// (Updatable) The User or App who modified the Resource
	IdcsLastModifiedBy []IdentityPropagationTrustIdcsLastModifiedByObservation `json:"idcsLastModifiedBy,omitempty" tf:"idcs_last_modified_by,omitempty"`
	...
	// (Updatable) A list of tags on this resource.
	Tags []IdentityPropagationTrustTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`
...
type IdentityPropagationTrustParameters struct {
	...
	// (Updatable) A list of tags on this resource.
	// +kubebuilder:validation:Optional
	Tags []IdentityPropagationTrustTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
...
type IdentityPropagationTrustTagsInitParameters struct {
...
type IdentityPropagationTrustTagsObservation struct {
...
type IdentityPropagationTrustTagsParameters struct {
...
type ImpersonationServiceUsersInitParameters struct {
	...
	// (Updatable) Claim Value
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/cluster/identitydomains/v1alpha1.User
...
type IdentityPropagationTrustSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     IdentityPropagationTrustParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider IdentityPropagationTrustInitParameters `json:"initProvider,omitempty"`
}

// IdentityPropagationTrustStatus defines the observed state of IdentityPropagationTrust.
type IdentityPropagationTrustStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        IdentityPropagationTrustObservation `json:"atProvider,omitempty"`
}
...
// IdentityPropagationTrust is the Schema for the IdentityPropagationTrusts API. Provides the Identity Propagation Trust resource in Oracle Cloud Infrastructure Identity Domains service
...
type IdentityPropagationTrust struct {
	...
	Spec   IdentityPropagationTrustSpec   `json:"spec"`
	Status IdentityPropagationTrustStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// IdentityPropagationTrustList contains a list of IdentityPropagationTrusts
type IdentityPropagationTrustList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []IdentityPropagationTrust `json:"items"`
}

// Repository type metadata.
var (
	IdentityPropagationTrust_Kind             = "IdentityPropagationTrust"
	IdentityPropagationTrust_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: IdentityPropagationTrust_Kind}.String()
	IdentityPropagationTrust_KindAPIVersion   = IdentityPropagationTrust_Kind + "." + CRDGroupVersion.String()
	IdentityPropagationTrust_GroupVersionKind = CRDGroupVersion.WithKind(IdentityPropagationTrust_Kind)
)

func init() {
	SchemeBuilder.Register(&IdentityPropagationTrust{}, &IdentityPropagationTrustList{})
}
