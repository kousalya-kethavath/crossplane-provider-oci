...
export TERRAFORM_PROVIDER_VERSION := 8.18.0
...
generate.resolve: generate
	...
	@go run github.com/crossplane/upjet/v2/cmd/resolver -g oci.upbound.io -a github.com/oracle/provider-oci/internal/apis -s -p ./apis/cluster/...
	@go run github.com/crossplane/upjet/v2/cmd/resolver -g oci.m.upbound.io -a github.com/oracle/provider-oci/internal/apis -s -p ./apis/namespaced/...
...
ifneq ($(SUBPACKAGES),monolith)
	...
	for pkg in $(SUBPACKAGE_LIST); do \
		GOFLAGS="$(NOFORK_GOFLAGS)" $(MAKE) build.subpackage.$$pkg PLATFORMS="$(PLATFORMS)" GOCACHE="$(NOFORK_GOCACHE)" GOMODCACHE="$(NOFORK_GOMODCACHE)" GOPATH="$(NOFORK_GOPATH)" || exit 1; \
	done; \
...
ifneq ($(BUILD_PLATFORMS),)
	...
	trap '$(MAKE) clean-patch' EXIT; \
	$(MAKE) $(PATCH_STAMP) GOCACHE="$(NOFORK_GOCACHE)" GOMODCACHE="$(NOFORK_GOMODCACHE)" GOPATH="$(NOFORK_GOPATH)"; \
	GOFLAGS="$(NOFORK_GOFLAGS)" $(MAKE) build.all PLATFORMS="$(BUILD_PLATFORMS)" GOCACHE="$(NOFORK_GOCACHE)" GOMODCACHE="$(NOFORK_GOMODCACHE)" GOPATH="$(NOFORK_GOPATH)"
else
	@:
endif
endif
...
generate:
	...
	trap '$(MAKE) clean-patch' EXIT; \
	$(MAKE) $(PATCH_STAMP) GOCACHE="$(NOFORK_GOCACHE)" GOMODCACHE="$(NOFORK_GOMODCACHE)" GOPATH="$(NOFORK_GOPATH)"; \
	GOFLAGS="$(NOFORK_GOFLAGS)" $(MAKE) generate.init GOCACHE="$(NOFORK_GOCACHE)" GOMODCACHE="$(NOFORK_GOMODCACHE)" GOPATH="$(NOFORK_GOPATH)"; \
	GOFLAGS="$(NOFORK_GOFLAGS)" $(MAKE) generate.run GOCACHE="$(NOFORK_GOCACHE)" GOMODCACHE="$(NOFORK_GOMODCACHE)" GOPATH="$(NOFORK_GOPATH)"; \
	GOFLAGS="$(NOFORK_GOFLAGS)" $(MAKE) generate.done GOCACHE="$(NOFORK_GOCACHE)" GOMODCACHE="$(NOFORK_GOMODCACHE)" GOPATH="$(NOFORK_GOPATH)"

test:
	@set -e; \
	trap '$(MAKE) clean-patch' EXIT; \
	$(MAKE) $(PATCH_STAMP) GOCACHE="$(NOFORK_GOCACHE)" GOMODCACHE="$(NOFORK_GOMODCACHE)" GOPATH="$(NOFORK_GOPATH)"; \
	GOFLAGS="$(NOFORK_GOFLAGS)" $(MAKE) test.init GOCACHE="$(NOFORK_GOCACHE)" GOMODCACHE="$(NOFORK_GOMODCACHE)" GOPATH="$(NOFORK_GOPATH)"; \
	GOFLAGS="$(NOFORK_GOFLAGS)" $(MAKE) test.run GOCACHE="$(NOFORK_GOCACHE)" GOMODCACHE="$(NOFORK_GOMODCACHE)" GOPATH="$(NOFORK_GOPATH)"; \
	GOFLAGS="$(NOFORK_GOFLAGS)" $(MAKE) test.done GOCACHE="$(NOFORK_GOCACHE)" GOMODCACHE="$(NOFORK_GOMODCACHE)" GOPATH="$(NOFORK_GOPATH)"

lint:
	@set -e; \
	trap '$(MAKE) clean-patch' EXIT; \
	$(MAKE) $(PATCH_STAMP) GOCACHE="$(NOFORK_GOCACHE)" GOMODCACHE="$(NOFORK_GOMODCACHE)" GOPATH="$(NOFORK_GOPATH)"; \
	GOFLAGS="$(NOFORK_GOFLAGS)" $(MAKE) lint.init GOCACHE="$(NOFORK_GOCACHE)" GOMODCACHE="$(NOFORK_GOMODCACHE)" GOPATH="$(NOFORK_GOPATH)"; \
	GOFLAGS="$(NOFORK_GOFLAGS)" $(MAKE) lint.run GOCACHE="$(NOFORK_GOCACHE)" GOMODCACHE="$(NOFORK_GOMODCACHE)" GOPATH="$(NOFORK_GOPATH)"; \
	GOFLAGS="$(NOFORK_GOFLAGS)" $(MAKE) lint.done GOCACHE="$(NOFORK_GOCACHE)" GOMODCACHE="$(NOFORK_GOMODCACHE)" GOPATH="$(NOFORK_GOPATH)"
